...
export default class jTranslate {
    ...
    /**
     * Convenience bootstrap used by consumers (e.g. `JiZy.i18n.init('fr', data)`):
     * register a language's translations and make it the active language.
     */
    init(langCode, translations) {
        this.addTranslations(langCode, translations);
